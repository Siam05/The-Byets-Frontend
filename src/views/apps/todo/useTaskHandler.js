...
export default function useTaskHandler(props, emit) {
  ...
  const assigneeOptions = [
    { avatar: require('@/assets/images/avatars/2.png'), fullName: 'Jane Foster' },
    { avatar: require('@/assets/images/avatars/2.png'), fullName: 'Donna Frank' },
    { avatar: require('@/assets/images/avatars/2.png'), fullName: 'Gabrielle Robertson' },
    { avatar: require('@/assets/images/avatars/2.png'), fullName: 'Lori Spears' },
    { avatar: require('@/assets/images/avatars/2.png'), fullName: 'Sandy Vega' },
    { avatar: require('@/assets/images/avatars/2.png'), fullName: 'Cheryl May' },
  ]
