...
export default {
  ...
  setup(_, { emit }) {
    ...
    const emailToOptions = [
      { avatar: require('@/assets/images/avatars/2.png'), name: 'Jane Foster' },
      { avatar: require('@/assets/images/avatars/2.png'), name: 'Donna Frank' },
      { avatar: require('@/assets/images/avatars/2.png'), name: 'Gabrielle Robertson' },
      { avatar: require('@/assets/images/avatars/2.png'), name: 'Lori Spears' },
      { avatar: require('@/assets/images/avatars/2.png'), name: 'Sandy Vega' },
